...
-- CreateTable
CREATE TABLE "ColumnWrapper" (
    "id" TEXT NOT NULL,
    "columnId" TEXT NOT NULL,
    "createdAt" TIMESTAMP(3) NOT NULL DEFAULT CURRENT_TIMESTAMP,
    "updatedAt" TIMESTAMP(3) NOT NULL,

    CONSTRAINT "ColumnWrapper_pkey" PRIMARY KEY ("id")
);
...
-- CreateIndex
CREATE UNIQUE INDEX "ColumnWrapper_columnId_key" ON "ColumnWrapper"("columnId");
...
-- AddForeignKey
ALTER TABLE "ColumnWrapper" ADD CONSTRAINT "ColumnWrapper_columnId_fkey" FOREIGN KEY ("columnId") REFERENCES "Column"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "Board" ADD CONSTRAINT "Board_columnWrapperId_fkey" FOREIGN KEY ("columnWrapperId") REFERENCES "ColumnWrapper"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
